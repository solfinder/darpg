...
<%
		...
		ResultSet rs=stmt.executeQuery("select state,count(*) from users group by state"); 
    ...
    <script type="text/javascript">
      ...
      function drawChart() {
           // Define the chart to be drawn.
            ...
            var baroptions = {title: 'Users',  width: 1600,
        height: 1600,
		position: 'top',
		...
		var pieoptions = {title: 'Users',  width: 1600,
        height: 1600,
		position: 'top',
        legend: { position: 'top', maxLines: 3 },
		}
...
<!-- Page content -->
<div class="main">
<right><a href="javascript:window.open('users_help.html','Users Help');"><img src='help.png' width=20px height=20px align=right /></a></right>
